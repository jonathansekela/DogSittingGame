...
BACKGROUND = pg.image.load(
	'./Backgrounds/Free Pixel Art Forest/Preview/Background.png')
...
# load button images
start_img = pg.image.load(
	'./Menu Buttons/Large Buttons/Large Buttons/Play Button.png').convert_alpha()
stop_img = pg.image.load(
	'./Menu Buttons/Large Buttons/Large Buttons/Quit Button.png').convert_alpha()
...
# load menu music
pg.mixer.music.load(
	'Music/Abstraction - Ludum Dare 28 Loops/Ludum Dare 28 - Track 1.wav')
